...
@available(*, deprecated, message: "Move to the new OpenAI API")  //Apple doesn't provide a way to set the speed &/or the volume of the `say CLI tool`, which can be a problem...
var listOfSayVoices = ["Samantha", "Victoria", "Alex", "Fred"]

var accessibilityVoices = [
    "system", "alloy", "ash", "ballad", "coral", "echo", "fable", "nova", "onyx", "sage", "shimmer",
    "verse",
]
...
@available(*, deprecated, message: "Move away from this")  //TODO: Remove from codebase
var userPrefs = mySettings(
    isAccessibility: false, accessibilityHoldDownTime: 5.0, accessibilityVoice: "Samantha",
    isForcedTitle: false, searchRefs: 0, textFieldRefs: 0, dropdownRefs: 0)
